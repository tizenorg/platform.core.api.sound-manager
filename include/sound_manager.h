...
/**
 * @brief Sets auto focus reacquistion property.
 * @since_tizen 3.0
 * @param[in]	stream_info			The handle of stream information
 * @param[in]	reacquisition	The auto focus reacquistion property to set : (@c true = inable, @c false = disable)
 *
 * @return @c 0 on success,
 *         otherwise a negative error value
 * @retval #SOUND_MANAGER_ERROR_NONE Success
 ...
 * @see sound_manager_create_stream_information()
 */
int sound_manager_set_focus_reacquisition(sound_stream_info_h stream_info, bool reacquisition);

/**
 * @brief Gets auto focus reacquistion property.
 * @since_tizen 3.0
 * @param[in]	stream_info			The handle of stream information
 * @param[out]	reacquisition	The value of focus reacqusition propery : (@c true = inabled, @c false = disabled)
 *
 * @return @c 0 on success,
 *         otherwise a negative error value
 * @retval #SOUND_MANAGER_ERROR_NONE Success
 ...
 * @see sound_manager_create_stream_information()
 */
int sound_manager_get_focus_reacquisition(sound_stream_info_h stream_info, bool *reacquisition);
