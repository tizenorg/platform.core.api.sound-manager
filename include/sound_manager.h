...
typedef enum {
	...
	SOUND_STREAM_TYPE_MEDIA_EXTERNAL,     /**< Sound stream type for media for external devices */
} sound_stream_type_e;
...
typedef enum {
	...
	SOUND_STREAM_FOCUS_CHANGED_BY_MEDIA_EXTERNAL,    /**< Changed by the stream type for media for external devices */
