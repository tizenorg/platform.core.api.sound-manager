 ...
 * @since_tizen 3.0
 * @param[in]	stream_info			The handle of stream information
 * @param[in]	reacquisition	The auto focus reacquisition property to set : (@c true = enable, @c false = disable)
 *
 * @return @c 0 on success,
 *         otherwise a negative error value
 * @retval #SOUND_MANAGER_ERROR_NONE Success
 ...
 * @since_tizen 3.0
 * @param[in]	stream_info			The handle of stream information
 * @param[out]	reacquisition	The value of focus reacquisition property : (@c true = enabled, @c false = disabled)
 *
 * @return @c 0 on success,
 *         otherwise a negative error value
 * @retval #SOUND_MANAGER_ERROR_NONE Success
 ...
 * @see sound_manager_create_stream_information()
 */
int sound_manager_get_focus_reacquisition(sound_stream_info_h stream_info, bool *eabled);
