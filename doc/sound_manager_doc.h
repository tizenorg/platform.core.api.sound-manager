 ...
 * @brief  The @ref CAPI_MEDIA_SOUND_MANAGER_MODULE  API provides functions to get and set sound parameters like volume, stream_policy, session policy and devices.
 *
...
/**
 * @ingroup CAPI_MEDIA_SOUND_MANAGER_MODULE
 * @defgroup CAPI_MEDIA_SOUND_MANAGER_STREAM_POLICY_MODULE Stream
