...
static void displaymenu()
{
	...
	{
		g_print("*** input stream type to create stream information (0:media, 1:alarm, 2:notification, 3:ringtone-call, 4:voice-call, 5:voip, 6:media-ext)\n");
	}
	...
	switch (g_menu_state)
	{
		...
		case CURRENT_STATUS_CREATE_STREAM_INFO:
		{
			...
			case 5: /* voip */
				...
				break;
			case 6: /* media external */
				type = SOUND_STREAM_TYPE_MEDIA_EXTERNAL;
				break;
			default:
				type = SOUND_STREAM_TYPE_MEDIA;
				break;
