...
static void displaymenu()
{
	...
	if (g_menu_state == CURRENT_STATUS_MAINMENU) {
		...
		g_print("*** input stream type to create stream information (0:media, 1:alarm, 2:notification, 3:ringtone-call, 4:voice-call, 5:voip, 6:external-media)\n");
...
static void interpret(char *cmd)
{
	...
	case CURRENT_STATUS_CREATE_STREAM_INFO: {
		...
		case 5: /* voip */
			...
			break;
		case 6: /* external media */
			type = SOUND_STREAM_TYPE_EXTERNAL_MEDIA;
			break;
		default:
			type = SOUND_STREAM_TYPE_MEDIA;
			break;
