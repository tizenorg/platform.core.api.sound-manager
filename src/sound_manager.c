...
int sound_manager_set_focus_reacquisition_state(sound_stream_info_h stream_info, bool enable)
{
	int ret = MM_ERROR_NONE;
	sound_stream_info_s *stream_h = (sound_stream_info_s*)stream_info;
...
int sound_manager_get_focus_reacquisition_state(sound_stream_info_h stream_info, bool *enabled)
{
	int ret = MM_ERROR_NONE;
	sound_stream_info_s *stream_h = (sound_stream_info_s*)stream_info;
